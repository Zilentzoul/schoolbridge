    ...
    <div style={{
      ...
      <main className="main-pad" style={{ flex: 1, padding: "28px 32px", maxWidth: "100%", overflowX: "hidden", marginTop: 0 }}>
        <div style={{ maxWidth: 1180, margin: "0 auto" }}>
          ...
          {tab === "grades" && <Grades ward={ward} role={role} demo={demo} notify={notify} />}
...
// ========================= GRADES =========================
function Grades({ ward }) {
  return (
    <>
      <PageHead eyebrow="Academics" title="Grades & reports" sub={`${ward.name} · Term 3, 2025`}
        right={<button className="btn" style={secondaryBtn}><Download size={16} /> Download report card</button>} />
